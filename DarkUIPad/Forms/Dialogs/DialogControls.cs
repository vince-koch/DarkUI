...
namespace DarkUIPad.Forms.Dialogs
{
    public partial class DialogControls : DarkDialog
    {
        public DialogControls()
        {
            ...
            {
                DarkMessageBox.Show(this, "This is an error", "Dark UI Pad", MessageBoxIcon.Error);
            };

            btnMessageBox.Click += delegate
            {
                DarkMessageBox.Show(this, "This is some information, except it is much bigger, so there we go. I wonder how this is going to go. I hope it resizes properly. It probably will.", "Dark UI Pad", MessageBoxIcon.Warning);
            };
        }
    }
}
